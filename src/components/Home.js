...
export const Home = () =>{
            ...
            <div className="home-main">
                <div className="navbar" id="navbarr">
                    ...
                    <div>
                        ...
                        <button className="home-button " onClick={handleAbout}>About Us</button>
    ...
    <h1 style={{ textAlign: "center", margin: "150px 0", fontSize: "110px" }}>Tourism And Hospitality Management System</h1>
