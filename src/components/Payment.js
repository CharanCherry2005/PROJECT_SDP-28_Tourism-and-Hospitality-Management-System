    ...
    return(
        <div className="payment-main center">
            ...
            <   div className="center">
                    <label htmlFor="nameOfCustomerPayment">NAME: </label>
                    <input type="text" className="payment-input" value={nameOfPerson} readOnly id="nameOfCustomerPayment"></input>
                </div>
                <div className="center">
                    <label htmlFor="numberOfCustomerPayment">PH_NO: </label>
                    <input type="text" className="payment-input" value={MobileNumOfPerson} readOnly id="numberOfCustomerPayment"></input>
                </div>
                <div className="center">
                    <label htmlFor="membersOfCustomerPayment">MEM: </label>
                    <input type="text" className="payment-input" value={numberOfPeopleHotel} readOnly id="membersOfCustomerPayment"></input>
                </div>
                <div className="center">
                    <label htmlFor="nameOfHotelPayment">HOTEL: </label>
                    <input type="text" className="payment-input" value={nameHotel} readOnly id="nameOfHotelPayment"></input>
                </div>
                <div className="center">
                    <label htmlFor="stateOfHotelPayment">STATE: </label>
                    <input type="text" className="payment-input" value={stateHotel} readOnly id="stateOfHotelPayment"></input>
                </div>
                <div className="center">
                    <label htmlFor="placeOfHotelPayment">PLACE: </label>
                    <input type="text" className="payment-input" value={placeHotel} readOnly id="placeOfHotelPayment"></input>
                </div>
                <div className="center">
                    <label htmlFor="costOfHotelPayment">COST: </label>
                    <input type="text" className="payment-input" value={new Intl.NumberFormat('en-IN').format(indianCostPerNight)} readOnly id="costOfHotelPayment"></input>
                </div>
                <div className="center">
                    <h1>Enter the data below this....</h1>
                </div>
                <div className="center">
                    <label htmlFor="fromDateOfHotelPayment">FROM: </label>
                    <input type="date" className="payment-input" min={getTodayDate()} id="fromDateOfHotelPayment" onChange={handleNumberOfDays}></input>
                </div>
                <div className="center">
                    <label htmlFor="toDateOfHotelPayment">TO: </label>
                    <input type="date" className="payment-input" min={getTodayDate()}  id="toDateOfHotelPayment" onChange={handleNumberOfDays}></input>
                </div>
                <div className="center">
                    <label htmlFor="daysOfHotelPayment">DAYS: </label>
                    <input type="text" className="payment-input" id="daysOfHotelPayment" readOnly></input>
                </div>
                <div className="center">
                    <label htmlFor="totalCostOfHotelPayment">TOTAL: </label>
                    <input type="text" className="payment-input" id="totalCostOfHotelPayment" readOnly></input>
                </div>
                <div className="center">
                    <button className="button1" onClick={handleConfirm} id="paymentConfirm">Confirm</button>                    
                 ...
                 <button className="button1" onClick={handleHome}>Home</button>
            </div>
        </div>
    );
}
